...
export class ProductsController {
    ...
    async getProducts(limit, page, sort, query) {
        ...
        // 1er Parametro para que le Asigno al paginado - para hacer el Filtrado
        const criteria= {}
        
        // Filtrando lo Productos por tu Categoria
        if (!query) criteria 
        if (query === 'fruta' || query === 'granos' || query === 'hortalizas') {
        ...
        const pagination = {
            ...
            lean: true,
            select: ['_id', 'title', 'price', 'stock', 'category', 'thumbnail', 'code']
        }
        ...
        try {
            ...
            // Utilizo los 2 primeros parametros del Metodo Paginate - [query]criteria y [options]
